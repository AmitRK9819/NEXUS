// ============================================================
// NEXUS — Zustand Store (Member 3: Mapper)
// ============================================================

import { create } from "zustand";
import type { ComplaintCategory, BRICSCountry, ComplaintPoint, InvestmentZone } from "@/lib/types";
...
// Jan 2025 → Jun 2025 in unix ms
const DEFAULT_TIME_START = new Date("2025-01-01").getTime();
const DEFAULT_TIME_END   = new Date("2025-06-30").getTime();
