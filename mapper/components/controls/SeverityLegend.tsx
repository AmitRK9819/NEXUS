"use client";
// ============================================================
// NEXUS — Severity Legend (Member 3: Mapper)
// ============================================================

export default function SeverityLegend() {
  const levels = [
    { label: "Critical",  range: "0.76–1.00", color: "bg-red-500",    dot: "🔴" },
    { label: "High",      range: "0.56–0.75", color: "bg-orange-400", dot: "🟠" },
    { label: "Moderate",  range: "0.31–0.55", color: "bg-yellow-400", dot: "🟡" },
    { label: "Low",       range: "0.00–0.30", color: "bg-green-400",  dot: "🟢" },
  ];
    ...
    <div className="bg-gray-900/80 backdrop-blur-md border border-white/10 rounded-2xl p-4 shadow-xl">
      ...
      <div className="mt-3 pt-3 border-t border-white/10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-purple-300 text-xs">Govt. Investment Zone</span>
        </div>
      </div>
    </div>
  );
