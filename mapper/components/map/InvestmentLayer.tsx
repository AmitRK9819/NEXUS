// ============================================================
// NEXUS — Deck.gl InvestmentLayer (Member 3: Mapper)
// Purple GeoJSON polygons = government spending zones
// ============================================================
...
export function InvestmentLayer() {
  ...
  return new GeoJsonLayer<InvProperties>({
    ...
    filled: true,
    stroked: true,
    getFillColor: [139, 92, 246, 45],     // purple-500 @ 18% opacity
    getLineColor: [167, 139, 250, 200],   // purple-400
    getLineWidth: 2,
