      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className={`w-full rounded-lg border px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus-visible:ring-2 focus-visible:ring-slate-900 ${
        ...
        <div className="flex gap-3 border-t border-slate-200 p-5">
          <button
            type="button"
            onClick={onCancel}
            className="flex-1 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 focus-visible:ring-2 focus-visible:ring-slate-900"
          >
            Cancel
          </button>
          <button
            ...
            className={`flex-1 rounded-lg px-4 py-2 text-sm font-medium focus-visible:ring-2 focus-visible:ring-slate-900 ${buttonClass}`}
          >
            {buttonLabel}
          </button>
        </div>
