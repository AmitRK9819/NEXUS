  ...
  return (
    ...
    >
      <div
        ...
        className="relative flex max-h-[90vh] w-full max-w-3xl flex-col rounded-xl border border-slate-200 bg-white shadow-2xl"
      >
        {/* Header */}
        <div className="flex items-start justify-between border-b border-slate-200 p-5">
          <div className="flex-1 pr-4">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2">
              ...
              <ConfidenceBar score={recommendation.confidence} showLabel={true} />
            </div>
          </div>
          <button
            ref={closeBtnRef}
        ...
        <div className="ai-disclosure-banner flex items-center gap-2 px-5 py-2.5">
          ...
          <p className="text-xs font-medium text-amber-800">
            Explainable AI Evidence — dual-metric synthesis of citizen grievances, PostGIS containment, and public budget plans.
          </p>
        </div>
        ...
        <div className="border-t border-slate-200 bg-slate-50 px-5 py-3">
          <button
            onClick={onClose}
            type="button"
            className="w-full rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 focus-visible:ring-2 focus-visible:ring-slate-900"
          >
            Close Explanation
          </button>
        </div>
